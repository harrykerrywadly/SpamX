...
from SpamX import BOT_USERNAME, OWNER_ID
from SpamX.config import get_str_key
from SpamX.function.pluginhelpers import convert_seconds_to_minutes as time_convert
from SpamX.function.pluginhelpers import fetch
...
async def alive_function(answers):
    ...
    msg = f"""
**[SpamX✨](https://github.com/Shavin77):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/SpamXhelper)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/74710a0f963f9d3c2d36e.jpg",
