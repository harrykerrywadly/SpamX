...
from SpamX.modules.utils.disable import disableable_dec
...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(
            strings["btn_source"], url="https://github.com/Shavin77/"
        ),
    )
    buttons.add(
        InlineKeyboardButton(strings["btn_channel"], url="https://t.me/SpamXsupport"),
        InlineKeyboardButton(
            strings["btn_group"], url="https://t.me/SpamX_support"
        ),
    )
    buttons.add(
        InlineKeyboardButton(
            "Add SpamX to your group",
            url=f"https://telegram.me/SpamX_GroupManagement_Bot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/SpamX_GroupManagement_Bot?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
