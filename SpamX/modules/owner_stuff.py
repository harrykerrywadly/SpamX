...
from SpamX import DAISY_VERSION, OWNER_ID, bot, dp
from SpamX.decorator import COMMANDS_ALIASES, REGISTRED_COMMANDS, register
from SpamX.modules import LOADED_MODULES
from SpamX.services.mongo import db, mongodb
...
async def stats(message):
    if message.from_user.id == OWNER_ID:
        text = f"<b>SpamX {SPAMX_VERSION} stats</b>\n"
